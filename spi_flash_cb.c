        ...
        case SFCB_CMD_MKCB:
            ...
            switch (self->stage) {
                ...
                case SFCB_STG01:
                     ...
                     */
                    self->uint32IterAdr = sfcb_flash_adr_head(self, (self->uint16Iter) + (uint16_t) 1) - (uint32_t) sizeof(spi_flash_cb_elem_head);
                ...
                case SFCB_STG02:
                    ...
                    self->uint32IterAdr = sfcb_flash_adr_head(self, (self->uint16Iter) + (uint16_t) 1);
